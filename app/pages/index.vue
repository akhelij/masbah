...
<template>
  <main>
    <section class="hero">
      ...
      <div
        class="blob"
        style="width: 320px; height: 320px; top: -80px; inset-inline-start: -60px"
      />
      <div
        class="blob"
        style="
      ...
      <div class="wrap" style="padding-block: clamp(2.75rem, 7vw, 5rem)">
        ...
        <div
          ...
          "
        >
          <span class="badge badge-cash">💵 {{ t('common.cashOnPlace') }}</span>
          <span class="badge" style="background: rgba(255, 255, 255, 0.16); color: #fff"
            >FR / العربية · RTL</span
          >
        </div>
        <div class="rise" style="margin-top: 1.6rem; animation-delay: 0.24s">
          <button class="btn btn-primary btn-lg">{{ t('common.book') }}</button>
        </div>
      </div>
      <svg
        viewBox="0 0 1440 70"
