<template>
    <div class="flex flex-row space-x-4 fixed right-10 bottom-10 z-50">
        <router-link :to="{ name: 'Profile' }">
            <TButton
                v-if="!creation_done && id != null"
                class="shadow-lg"
                :disabled="disable_for_loading"
            >
                Terminer
            </TButton>
        </router-link>
        <TButton
            v-if="!creation_done"
            class="shadow-lg"
            :button_disabled="disable_for_loading"
            @click="publish"
        >
            {{ id ? 'Modifier' : 'Publier' }} 📣
        </TButton>
    ...
    <div
        v-if="creation_done"
        class="flex flex-col items-center justify-center w-full space-y-5 py-10"
    >
        <h1 class="text-6xl font-bold">Félicitations 🥳🥳</h1>
        <p class="text-4xl font-bold px-5 text-center">
            Merci de votre générosité, vous n'avez plus qu'a attendre que l'un
            des locataires vous contacte pour venir profité dans votre petit
            bout de paradis !
        </p>
        <router-link
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        ...
                        <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                            <TInputError
                                v-if="v$.rules.$error"
                                :message="v$.rules.$errors[0].$message"
                            />
                            <div
                            ...
                            <div class="flex flex-col space-y-2 pt-5">
                                ...
                                <TTextArea
                                    v-model="more_rules"
                                    placeholder="Musique tolérer à faible volume par respect au voisinage"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="flex flex-col space-y-2 pt-5">
                                ...
                                <TInputError
                                    ...
                                    :message="
                                        v$.half_day_price.$errors[0].$message
                                    "
                                />
                                <TInput
                                    v-model="half_day_price"
                                    type="number"
                                    placeholder="Définir votre prix..."
                                />
                            </div>
                            ...
                            <div class="flex flex-col space-y-2 pt-5">
                                ...
                                <TInputError
                                    ...
                                    :message="
                                        v$.full_day_price.$errors[0].$message
                                    "
                                />
                                <TInput
                                    v-model="full_day_price"
                                    type="number"
                                    placeholder="Définir votre prix à la journée..."
                                />
                            </div>
                            ...
                            <div class="flex flex-col space-y-2 pt-5">
                                ...
                                <TInputError
                                    v-if="v$.extras.$error"
                                    :message="v$.extras.$errors[0].$message"
                                />
                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <div class="text-sm text-gray-600">
                            <p class="mt-1 text-sm text-gray-600">
                                Les information nécessaire au locataire pour
                                qu'il puisse avoir une idée de votre pissine.
                            </p>
                            ...
                            <ul class="ml-2">
                                ...
                                <li>
                                    ...
                                    <ul class="text-xs ml-3">
                                        <li>
                                            * Les points forts de votre pissine.
                                        </li>
                                        <li>
                                            * Les équipements que vous mettez à
                                            disposition de votre locataire.
                                        </li>
                                        <li>
                                            * Si le locataire doit vous
                                            contacter pour discuter d'une autre
                                            offre.
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 bg-white space-y-3 sm:p-6">
                            <div class="flex flex-col space-y-2 pt-2">
                                ...
                                <TInputError
                                    v-if="v$.max_people.$error"
                                    :message="v$.max_people.$errors[0].$message"
                                />
                                ...
                                <TInputError
                                    v-if="v$.min_people.$error"
                                    :message="v$.min_people.$errors[0].$message"
                                />
                                <div class="flex justify-between">
                                    <label
                                        class="block text-lg font-semibold text-gray-700"
                            ...
                            <div class="flex flex-col space-y-2 pt-2">
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        pour enregistrer votre annonce, et
                                        revenir un peu plus tard déposer vos
                                        photos.
                                    </span>
                                </label>
                                ...
                                <TUpload
                                    :media="files"
                                    @set_uploaded_files="get_uploaded_files"
                                    @set_upload_state="get_upload_state"
                                />
                            </div>
                            ...
                            <div class="flex flex-col space-y-2 pt-2">
                                ...
                                <TInputError
                                    v-if="v$.title.$error"
                                    :message="v$.title.$errors[0].$message"
                                />
                                <TInput
                                    v-model="title"
                                    placeholder="Un oasis de bien être​,​ à deux pas du centre de Casa."
                                />
                            </div>
                            ...
                            <div class="flex flex-col space-y-2 pt-2">
                                ...
                                <TTextArea
                                    v-model="description"
                                    placeholder="Ma piscine est propre et bien entretenue. 4 transats, Une table et quatre chaises sont en place. Il y a aussi un splendide BBQ à gaz pour un supplément de 100 dhs. Un frigo avec des petites glaces ou des snacks sera disponible gratuitement."
                                />
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex flex-col space-y-2 pt-2">
                                    ...
                                    <TTextArea
                                        v-model="address"
                                        placeholder="9 rue Tilleules, Allée des Corriandres, Villa B,  MAARIF"
                                    />
                                </div>
                                ...
                                >
                                    ...
                                    <TInputError
                                        v-if="v$.cleaning_product.$error"
                                        :message="
                                            v$.cleaning_product.$errors[0]
                                                .$message
                                        "
                                    />
                                    <TInput
                                        v-model="cleaning_product"
                                        placeholder="Chlore, Sel, Brome, Autre..."
                                    />
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    setup(props) {
        onMounted(() =>
            document.querySelector('#city').setAttribute('autocomplete', 'nope')
        ) //tip to disable the autocomplete of multiselect input
        ...
        if (props.id != null && announcement.value == '') {
            store
                .dispatch('getAnnouncementByIdAction', props.id)
                .then((response) => {
                    if (response.success) {
        ...
        watchEffect(() => {
            ...
            if (props.id != null && announcement.value != '') {
                ...
                console.log(form)
                if (
                    announcement.value.media != null &&
                    Object.keys(announcement.value.media).length > 0
                ) {
        ...
        const phoneValidation = helpers.regex(
        ...
        const publish = () => {
            ...
            if (store.getters.isAuth) {
                ...
                form.published =
                    form.media != null && Object.keys(form.media).length > 0
                store.dispatch('progressbar/start')
                v$.value.$validate()
                if (!v$.value.$error) {
                    let continue_without_uploading_images = true
                    if (!images_uploaded.value) {
                        continue_without_uploading_images = confirm(
                            "Vous n'avez pas encore finaliser l'upload de vos images, voulez vous continuer quand même ? "
                        )
                    }
