    ...
    <section class="relative w-full bg-white">
        ...
        >
            ...
            >
                ...
                >
                    <template #noResult>
                        Oups! Aucun élément trouvé. Pensez à modifier la requête
                        de recherche.
                    </template>
                </multiselect>
                ...
                <div class="flex flex-row space-x-4 items-center">
                    <TSecondaryButton
                        class="w-40 text-sm sm:text-md flex justify-center"
                    ...
                    >
                        <div class="flex flex-row space-x-2 items-center">
                            <svg
                                :class="no_data_found ? 'animate-pulse' : ''"
            ...
            <div
                v-if="no_data_found"
                class="p-5 flex items-center justify-center transform scale-75 md:scale-100  min-h-8/12"
            >
                <p class="text-4xl font-semibold text-center leading-normal">
...
export default {
    ...
    setup(props) {
        ...
        onMounted(() => {
            ...
            city.value = cities.find((c) => c.name === props.city);
            filterByCity();
        });
