<template>
    ...
    <section class="relative w-full bg-white">
        ...
        <div class="relative w-full  px-5 py-10 mx-auto sm:py-12 md:py-6 md:px-10 max-w-7xl">
            <div class="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0 md:items-center">
                ...
                <TSecondaryButton class="w-40 text-sm sm:text-md flex justify-center" @click.native="orderByPrice">
                    <span v-if="orderByPriceActive"> 🗓️ Filtrer par date </span>
                    <span v-else> 💰 Filtrer par prix </span>
                </TSecondaryButton>
                <TSecondaryButton class="text-sm sm:text-md"  @click="resetList">
