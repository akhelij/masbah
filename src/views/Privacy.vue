<template>
    <div class="p-5 sm:px-20 sm:py-10">
        ...
        <p>
            Mohamed Akhelij built the Pissina app as a Free app. This SERVICE is
            provided by Mohamed Akhelij at no cost and is intended for use as
            is.
        </p>
        <p>
        ...
        <p>
            ...
            our Terms and Conditions, which is accessible at Pissina unless
        ...
        <p>This policy is effective as of 2021-08-19</p>
        <p><strong>Contact Us</strong></p>
        <p>
            If you have any questions or suggestions about my Privacy Policy, do
            not hesitate to contact me at admin@pissina.com.
        </p>
    </div>
</template>
