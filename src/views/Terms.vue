<template>
    <div class="p-5 sm:px-20 sm:py-10">
        ...
        <p>
            ...
            property rights related to it, still belong to Mohamed Akhelij.
        </p>
        <p>
            Mohamed Akhelij is committed to ensuring that the app is as useful
        ...
        <p>
            The Pissina app stores and processes personal data that you have
            ...
            mean that the Pissina app won’t work properly or at all.
        </p>
        <div>
            <p>
        ...
        <p>
            You should be aware that there are certain things that Mohamed
            Akhelij will not take responsibility for. Certain functions of the
            ...
            provider, but Mohamed Akhelij cannot take responsibility for the app
        ...
        <p>
            ...
            you can’t turn it on to avail the Service, Mohamed Akhelij cannot
            accept responsibility.
        </p>
        <p>
            With respect to Mohamed Akhelij’s responsibility for your use of the
            ...
            so that we can make it available to you. Mohamed Akhelij accepts no
        ...
        <p>
            ...
            the updates if you want to keep using the app. Mohamed Akhelij does
        ...
        <p>
            ...
            Conditions, do not hesitate to contact me at admin@pissina.com.
        </p>
    </div>
</template>
